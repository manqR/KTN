...
use backend\models\ProdukKategoriSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ProdukKategoriController implements the CRUD actions for ProdukKategori model.
 */
class ProdukKategoriController extends Controller
{
    ...
    {
        if (($model = ProdukKategori::findOne($id)) !== null) {
            return $model;
        }
